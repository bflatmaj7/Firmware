...
#ifndef DRIVERS_IMU_SBG_ELLIPSE_D_SBGECOM_H_
#define DRIVERS_IMU_SBG_ELLIPSE_D_SBGECOM_H_
...
//- Global definitions                                                 -//
//----------------------------------------------------------------------//
#define SBG_ECOM_MAX_BUFFER_SIZE				(112)							/*!< Maximum reception buffer size in bytes. */
#define SBG_ECOM_MAX_PAYLOAD_SIZE				(102)							/*!< Maximum payload size in bytes. */
...
enum ELLIPSE_D_PARSE_STATE {
	ELLIPSE_D_PARSE_STATE0_UNSYNC = 0,
	ELLIPSE_D_PARSE_STATE1_SYNC1,
	ELLIPSE_D_PARSE_STATE2_SYNC2,
	ELLIPSE_D_PARSE_STATE3_MSG,
	ELLIPSE_D_PARSE_STATE4_CLASS,
	ELLIPSE_D_PARSE_STATE5_LEN1,
	ELLIPSE_D_PARSE_STATE6_LEN2,
	ELLIPSE_D_PARSE_STATE7_DATA,
	ELLIPSE_D_PARSE_STATE8_CRC1,
	ELLIPSE_D_PARSE_STATE9_CRC2
};
...
#endif /* DRIVERS_IMU_SBG_ELLIPSE_D_SBGECOM_H_ */
