...
static void mavlink_test_meteo(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
    mavlink_status_t *status = mavlink_get_channel_status(MAVLINK_COMM_0);
        if ((status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) && MAVLINK_MSG_ID_METEO >= 256) {
            return;
        }
#endif
    mavlink_message_t msg;
    ...
    mavlink_meteo_t packet1, packet2;
        ...
        packet1.pt100 = packet_in.pt100;
        
        
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
        if (status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) {
           // cope with extensions
           memset(MAVLINK_MSG_ID_METEO_MIN_LEN + (char *)&packet1, 0, sizeof(packet1)-MAVLINK_MSG_ID_METEO_MIN_LEN);
        }
#endif
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_meteo_encode(system_id, component_id, &msg, &packet1);
    mavlink_msg_meteo_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_meteo_pack(system_id, component_id, &msg , packet1.time_usec , packet1.temperature , packet1.humidity , packet1.t_pot_v , packet1.q_hu , packet1.pt100 );
    mavlink_msg_meteo_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_meteo_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.time_usec , packet1.temperature , packet1.humidity , packet1.t_pot_v , packet1.q_hu , packet1.pt100 );
    mavlink_msg_meteo_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mavlink_msg_meteo_decode(last_msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_meteo_send(MAVLINK_COMM_1 , packet1.time_usec , packet1.temperature , packet1.humidity , packet1.t_pot_v , packet1.q_hu , packet1.pt100 );
    mavlink_msg_meteo_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}

static void mavlink_test_ins(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
    mavlink_status_t *status = mavlink_get_channel_status(MAVLINK_COMM_0);
        if ((status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) && MAVLINK_MSG_ID_INS >= 256) {
            return;
        }
#endif
    mavlink_message_t msg;
    ...
    mavlink_ins_t packet1, packet2;
        ...
        packet1.pitch = packet_in.pitch;
        packet1.yaw = packet_in.yaw;
        packet1.vns = packet_in.vns;
        packet1.vew = packet_in.vew;
        packet1.vud = packet_in.vud;
        
        
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
        if (status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) {
           // cope with extensions
           memset(MAVLINK_MSG_ID_INS_MIN_LEN + (char *)&packet1, 0, sizeof(packet1)-MAVLINK_MSG_ID_INS_MIN_LEN);
        }
#endif
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_ins_encode(system_id, component_id, &msg, &packet1);
...
static void mavlink_test_mhp(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
    mavlink_status_t *status = mavlink_get_channel_status(MAVLINK_COMM_0);
        if ((status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) && MAVLINK_MSG_ID_MHP >= 256) {
            return;
        }
#endif
    mavlink_message_t msg;
    ...
    mavlink_mhp_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        packet1.time_usec = packet_in.time_usec;
        packet1.dp0 = packet_in.dp0;
        packet1.dp1 = packet_in.dp1;
        packet1.dp2 = packet_in.dp2;
        packet1.dp3 = packet_in.dp3;
        packet1.dp4 = packet_in.dp4;
        packet1.dpS = packet_in.dpS;
        ...
        if (status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) {
           // cope with extensions
           memset(MAVLINK_MSG_ID_MHP_MIN_LEN + (char *)&packet1, 0, sizeof(packet1)-MAVLINK_MSG_ID_MHP_MIN_LEN);
        }
#endif
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_mhp_encode(system_id, component_id, &msg, &packet1);
    mavlink_msg_mhp_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_mhp_pack(system_id, component_id, &msg , packet1.time_usec , packet1.dp0 , packet1.dp1 , packet1.dp2 , packet1.dp3 , packet1.dp4 , packet1.dpS , packet1.tas , packet1.aoa , packet1.aos );
    mavlink_msg_mhp_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_mhp_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.time_usec , packet1.dp0 , packet1.dp1 , packet1.dp2 , packet1.dp3 , packet1.dp4 , packet1.dpS , packet1.tas , packet1.aoa , packet1.aos );
    mavlink_msg_mhp_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mavlink_msg_mhp_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
        
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_mhp_send(MAVLINK_COMM_1 , packet1.time_usec , packet1.dp0 , packet1.dp1 , packet1.dp2 , packet1.dp3 , packet1.dp4 , packet1.dpS , packet1.tas , packet1.aoa , packet1.aos );
    mavlink_msg_mhp_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}
...
static void mavlink_test_common(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
    ...
    mavlink_test_meteo(system_id, component_id, last_msg);
    mavlink_test_ins(system_id, component_id, last_msg);
    mavlink_test_mhp(system_id, component_id, last_msg);
}
